...
const RENDERERS = {
    ...
    render_local_calculate_mean,
    render_local_calculate_minmax,
    render_local_calculate_std,
    render_local_calculate_histogram,
    render_local_threshold_mask,
    render_contour_overlay,
    contour_overlay: render_contour_overlay,
    render_layer_difference,
    layer_difference: render_layer_difference,
    render_layer_summary,
    layer_summary: render_layer_summary,
    render_threshold_highlight,
